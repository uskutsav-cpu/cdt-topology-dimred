...
chains=[];inputs={};parameters=[];lineage=[]
for job in a.jobs:
    ...
    p=ROOT/'data/raw'/job/'diagnostics.csv';inputs[job]=hashlib.sha256(p.read_bytes()).hexdigest()
    d=np.genfromtxt(p,names=True,delimiter=',',dtype=None,encoding='utf8')
