...
job='99188cc153094acfc0b4';exact=[];sampled=[];sampling_variance=[];runs=[]
for ix in [0,5,50,100,150,200,250,300]:
    ...
    exact.append(P[mask].mean(axis=0));sampled.append(v.mean(axis=0));sampling_variance.append(v.var(axis=0,ddof=1)/n*(N-n)/(N-1))
